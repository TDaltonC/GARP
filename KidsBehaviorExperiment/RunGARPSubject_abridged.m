...
limitGARPOrder = []; % The fixxed order that the limitGARP trials will be presented in. If there are more tials that need to be shown then we have, then a second list (random order) is made and concatinated on to the end of the old one.
i=1;
...
settings.limitTasks     = limitGARPTasks;
settings.limitOrder     = limitGARPOrder;
